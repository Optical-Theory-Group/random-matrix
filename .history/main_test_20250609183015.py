...
input_statistics_manager = InputStatisticsManager(
    simulation_name, medium_parameters, medium_statistics, my_grid, supplied_indices=supplied_indices
)
...
cov_results = integration_result_list.by_statistic_type("covariance_dirac")
